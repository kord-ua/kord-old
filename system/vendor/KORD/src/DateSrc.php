...
use KORD\Date;
use KORD\Date\Format as DateFormat;
...
class DateSrc
{
     ...
     *
     *     $seconds = \KORD\Date::offset('America/Chicago', 'GMT');
     *
     ...
     *
     *     $seconds = \KORD\Date::seconds(); // 01, 02, 03, ..., 58, 59, 60
     *
     ...
     *
     *     $minutes = \KORD\Date::minutes(); // 05, 10, 15, ..., 50, 55, 60
     *
     * @uses    \KORD\Date::seconds
     * @param   integer $step   amount to increment each step by, 1 to 30
     * @return  array   A mirrored (foo => foo) array from 1-60.
     */
     ...
     *
     *     $hours = \KORD\Date::hours(); // 01, 02, 03, ..., 10, 11, 12
     *
     ...
     *
     *     $type = \KORD\Date::ampm(12); // PM
     *     $type = \KORD\Date::ampm(1);  // AM
     *
     ...
     *
     *     \KORD\Date::days(4, 2010); // 1, 2, 3, ..., 28, 29, 30
     *
     ...
     *
     * But you can customise this by passing in either \KORD\Date::MONTHS_LONG
     *
     *     \KORD\Date::months(Date::MONTHS_LONG);
     *     // array(1 => 'January', 2 => 'February', ..., 12 => 'December')
     *
     * Or \KORD\Date::MONTHS_SHORT
     *
     *     \KORD\Date::months(Date::MONTHS_SHORT);
     *     // array(1 => 'Jan', 2 => 'Feb', ..., 12 => 'Dec')
     *
     * @uses    \KORD\Date::hours
     ...
     *
     *     $years = \KORD\Date::years(2000, 2010); // 2000, 2001, ..., 2009, 2010
     *
     ...
     * Also consider using [\KORD\Date::fuzzySpan] when displaying a span.
     *
     *     $span = \KORD\Date::span(60, 182, 'minutes,seconds'); // array('minutes' => 2, 'seconds' => 2)
     *     $span = \KORD\Date::span(60, 182, 'minutes'); // 2
     *
     ...
     *
     *     $span = \KORD\Date::fuzzySpan(time() - 10); //less than a minute ago
     * 
     *     $span = \KORD\Date::fuzzySpan(time(), time() + 86400); //1 day ago 
     *
     ...
     * Converting the other direction is done using {@link \KORD\Date::dos2unix}.
     *
     *     $dos = \KORD\Date::unix2dos($unix);
     *
     ...
     * this is needed, but some binary formats use it (eg: zip files.)
     * Converting the other direction is done using {@link \KORD\Date::unix2dos}.
     *
     *     $unix = \KORD\Date::dos2unix($dos);
     *
     ...
     *
     *     $time = \KORD\Date::formattedTime('5 minutes ago');
     *
