...
class URLSrc
{
     ...
     *     echo \KORD\URL::base('https', true);
     *
     *     // Absolute URL path with host and protocol from $request
     *     echo \KORD\URL::base($request);
     *
     * @param   mixed    $protocol Protocol string, [\KORD\Request], or boolean
     * @param   boolean  $index    Add index file to URL?
     * @return  string
     * @uses    \KORD\Core::$index_file
     * @uses    \KORD\Request::protocol()
     */
     ...
     *
     *     echo \KORD\URL::site('foo/bar');
     *
     * @param   string  $uri        Site URI to convert
     * @param   mixed   $protocol   Protocol string or [\KORD\Request] class to use protocol from
    ...
    public static function site($uri = '', $protocol = null, $index = true)
    {
        ...
        if (!UTF8::isAscii($path)) {
            ...
            $path = preg_replace_callback('~([^/]+)~', '\KORD\URL::rawurlencodeCallback', $path);
        }
     ...
     *     $query = \KORD\URL::query(['sort' => 'title', 'limit' => 10]);
     *
