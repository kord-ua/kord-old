...
class HTMLSrc
{
    ...
    {
        return htmlspecialchars((string) $value, ENT_QUOTES, Encoding::$default, $double_encode);
    }
    ...
    {
        return htmlentities((string) $value, ENT_QUOTES, Encoding::$default, $double_encode);
    }
