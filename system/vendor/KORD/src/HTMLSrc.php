...
class HTMLSrc
{
    ...
    /**
     * @var string  Default path to public directory
     */
     ...
     *
     *     echo \KORD\HTML::entities($username);
     *
     * @param   string  $value          string to convert
     * @param   boolean $double_encode  encode existing entities
     * @return  string
     ...
     *
     *     echo \KORD\HTML::anchor('/user/profile', 'My Profile');
     *
     ...
     *
     *     echo \KORD\HTML::file_anchor('media/doc/user_guide.pdf', 'User Guide');
     *
     ...
     * @uses    \KORD\HTML::attributes
     */
    public static function fileAnchor($file, $title = null, array $attributes = null, $protocol = null, $index = false)
    {
        if ($title === null) {
     ...
     *
     *     echo \KORD\HTML::style('media/css/screen.css');
     *
    ...
    public static function style($file, array $attributes = null, $protocol = null, $index = false)
    {
        if (strpos($file, '://') === false) {
            // Add the base URL
            $file = URL::site(HTML::$public_dir . '/' . $file, $protocol, $index);
        }
     ...
     *
     *     echo \KORD\HTML::script('media/js/jquery.min.js');
     *
     * @param   string  $file       file name
     * @param   array   $attributes default attributes
     * @param   mixed   $protocol   protocol to pass to URL::base()
     ...
     *
     *     echo \KORD\HTML::image('media/img/logo.png', ['alt' => 'My Company']);
     *
     * @param   string  $file       file name
     * @param   array   $attributes default attributes
     * @param   mixed   $protocol   protocol to pass to URL::base()
     ...
     * Attributes will be sorted using \KORD\HTML::$attribute_order for consistency.
     *
     *     echo '<div'.\KORD\HTML::attributes($attrs).'>'.$content.'</div>';
     *
