...
class ProfilerSrc
{
     ...
     *
     *     $token = \KORD\Profiler::start('test', 'profiler');
     *
    ...
    {
        // Stop the benchmark
        Profiler::$marks[$token]['stop_time'] = microtime(true);
        Profiler::$marks[$token]['stop_memory'] = memory_get_usage();
    }
    ...
    public static function groups()
    {
        ...
        foreach (Profiler::$marks as $token => $mark) {
     ...
     *
     *     list($time, $memory) = \KORD\Profiler::total($token);
     *
     * @param   string  $token
     ...
     *
     *     list($time, $memory) = \KORD\Profiler::application();
     *
     * @return  array  execution time, memory
    ...
    public static function application()
    {
        ...
        $time = microtime(true) - KORD_START_TIME;

        // Get the total memory usage
        $memory = memory_get_usage() - KORD_START_MEMORY;
